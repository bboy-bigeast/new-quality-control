...
def get_batch_info(request):
    ...
    try:
        if report_type in ['dryfilm', 'af11', 'bb1']:
...
def generate_pdf(request, report_id):
    ...
    template_mapping = {
        ...
        'af11': 'reports/report_template_af11.html', 
        'bb1': 'reports/report_template_bb1.html',
    ...
    valid_templates = [
        ...
        'reports/report_template_af11.html',
        'reports/report_template_bb1.html',
